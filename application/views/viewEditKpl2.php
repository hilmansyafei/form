      ...
      <div class="row">
        ...
        <div class="col-md-10">
          ...
          <div class="box box-primary">
            ...
            <?php $formAction = "";
            if ($statEdit==true) {
              $formAction = base_url()."welcome/kpl2/save.edit";
            }else{
              $formAction = base_url()."welcome/kpl2/save.new";
            } ?>
            <form role="form" class="form-horizontal" action="<?php echo $formAction ?>" method="POST" enctype="multipart/form-data">
              ...
              <div class="box-body">
               ...
               <!--  <div class="form-group">
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1" class="col-sm-2 control-label">KPL 1</label>
                  <div class="col-sm-8">
                    <select name='ID_KPI_L1' class="form-control" required>
                    <option value=''>-- Silahkan Pilih --</option>
                    <?php
                    $selected = "";
                    foreach ($kpl1 as $key => $value) {
                      if ($statEdit) {
                        if ($dataEdit[0]->ID_KPI_L1 == $value->ID_KPI_L1) {
                          $selected = "selected";
                        }
                      }
                      echo "<option value='".$value->ID_KPI_L1."' $selected>".$value->ID_KPI_L1."</option>";
                      $selected = "";
                    }
                    ?>
                    </select>
