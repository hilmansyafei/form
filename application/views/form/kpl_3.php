        ...
        <div class="col-xs-12">
          <div class="box box-primary box-solid">
            <div class="box-header">
              <h3 class="box-title">KPL 3</h3>

              <a href="<?php base_url()?>kpl3/viewNew" class="btn btn-success" style="margin-left:10px"> <i class="fa fa-plus"></i> Add New Item</a>
            </div>
            <!-- /.box-header -->
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                foreach ($data as $key => $value) {
                  ...
                  echo "<td><a href='".base_url()."welcome/kpl3/viewEdit/".$value->ID_KPI_L3."' class='btn btn-success'> <i class='fa fa-edit'></i></a>
                            <a href='".base_url()."welcome/kpl3/delete/".$value->ID_KPI_L3."' class='btn btn-danger' onclick=\"return confirm('Apakah anda yakin akan menghapus data ini ?');\"> <i class='fa fa-trash'></i></a> 
                        </td>";
                  echo "</tr>";
                  $no++;
                }
